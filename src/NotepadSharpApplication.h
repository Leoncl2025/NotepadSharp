...
#ifndef NOTEPADSHARPAPPLICATION_H
#define NOTEPADSHARPAPPLICATION_H
...
class NotepadSharpApplication : public SingleApplication
{
    Q_OBJECT

public:
    NotepadSharpApplication(int &argc, char **argv);
...
#endif // NOTEPADSHARPAPPLICATION_H
