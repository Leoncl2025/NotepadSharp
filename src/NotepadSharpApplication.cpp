...
NotepadSharpApplication::NotepadSharpApplication(int &argc, char **argv)
...
bool NotepadSharpApplication::init()
{
    qInfo(Q_FUNC_INFO);

#ifndef Q_OS_MACOS
    setWindowIcon(QIcon(QStringLiteral(":/icons/NotepadSharp.png")));
#endif
    ...
    connect(this, &NotepadSharpApplication::aboutToQuit, this, &NotepadSharpApplication::saveSettings);
    ...
    connect(this, &NotepadSharpApplication::focusChanged, this, [&](QWidget *old, QWidget *now) {
        Q_UNUSED(old);
        if (now) {
    ...
    connect(this, &SingleApplication::receivedMessage, this, &NotepadSharpApplication::receiveInfoFromSecondaryInstance, Qt::QueuedConnection);

    connect(this, &NotepadSharpApplication::applicationStateChanged, this, [&](Qt::ApplicationState state) {
...
SessionManager *NotepadSharpApplication::getSessionManager() const
{
...
QString NotepadSharpApplication::getFileDialogFilter() const
{
    return getLuaState()->executeAndReturn<QString>("return DialogFilters()");
}

QString NotepadSharpApplication::getFileDialogFilterForLanguage(const QString &language) const
{
...
QStringList NotepadSharpApplication::getLanguages() const
{
...
void NotepadSharpApplication::setEditorLanguage(ScintillaNext *editor, const QString &languageName) const
{
...
QString NotepadSharpApplication::detectLanguage(ScintillaNext *editor) const
{
    qInfo(Q_FUNC_INFO);
...
QString NotepadSharpApplication::detectLanguageFromExtension(const QString &extension) const
{
    qInfo(Q_FUNC_INFO);
...
QString NotepadSharpApplication::detectLanguageFromContents(ScintillaNext *editor) const
{
    qInfo(Q_FUNC_INFO);
...
void NotepadSharpApplication::sendInfoToPrimaryInstance()
{
    qInfo(Q_FUNC_INFO);
...
void NotepadSharpApplication::receiveInfoFromSecondaryInstance(quint32 instanceId, QByteArray message)
{
    qInfo(Q_FUNC_INFO);
...
bool NotepadSharpApplication::isRunningAsAdmin() const
{
...
bool NotepadSharpApplication::event(QEvent *event)
{
...
void NotepadSharpApplication::openFiles(const QStringList &files)
{
    qInfo(Q_FUNC_INFO);
...
MainWindow *NotepadSharpApplication::createNewWindow()
{
    ...
    connect(window, &MainWindow::aboutToClose, this, &NotepadSharpApplication::saveSession);

    // Timer to autosave the session
    connect(&autoSaveTimer, &QTimer::timeout, this, &NotepadSharpApplication::saveSession);
    autoSaveTimer.start(60 * 1000);

    return window;
}

QStringList NotepadSharpApplication::debugInfo() const
{
    QStringList info;
