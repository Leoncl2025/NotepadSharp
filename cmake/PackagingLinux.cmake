...
set(APPIMAGE_ENV_VARS
    LDAI_OUTPUT=NotepadSharp-v${PROJECT_VERSION}-x86_64.AppImage
)
...
install(FILES
    ${PROJECT_SOURCE_DIR}/deploy/linux/NotepadSharp.desktop
    DESTINATION share/applications
)
install(FILES
    ${PROJECT_SOURCE_DIR}/icon/NotepadSharp.svg
...
add_custom_target(appimage
    COMMAND ${CMAKE_COMMAND} -E env
        ...
        ${LINUXDEPLOY}
        --appdir ${APPDIR}
        --executable ${APPDIR_USR}/bin/NotepadSharp
        --desktop-file ${APPDIR_USR}/share/applications/NotepadSharp.desktop
        --icon-file ${APPDIR_USR}/share/icons/hicolor/scalable/apps/NotepadSharp.svg
        --plugin qt
        --output appimage
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
